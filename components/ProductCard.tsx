  ...
  return (
    <div className="text-sm border-[1px] border-dark_blue/20 rounded-md bg-white group">
      <div className="relative group overflow-hidden bg-shop_light_bg">
        ...
        {product?.status === "sale" && (
          <p
            className="absolute top-2 left-2 z-10 text-xs border border-darkColor/50 px-2 rounded-full group-hover:border-shop_light_green
      ...
      <div className="p-3 flex flex-col gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="text-shop_light_text">5 Reviews</p>
        </div>
      </div>
    </div>
  );
